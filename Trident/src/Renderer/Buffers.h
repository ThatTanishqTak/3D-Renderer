...
namespace Trident
{
    ...
    public:
        ...
        void CreateStorageBuffers(uint32_t imageCount, VkDeviceSize bufferSize, std::vector<VkBuffer>& storageBuffers, std::vector<VkDeviceMemory>& storageBuffersMemory);
