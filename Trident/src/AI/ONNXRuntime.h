...
namespace Trident
{
    namespace AI
    {
        ...
        public:
            ...
            // Toggle DirectML provider usage, keeping DirectML as the primary accelerator when enabled.
        ...
        private:
            ...
            bool m_EnableDirectML; // Flag instructing the loader to append the DirectML execution provider first.
            bool m_EnableCPUFallback; // Flag indicating whether the CPU provider must be appended for deterministic fallback.
            bool m_IsDirectMLActive; // Tracks whether DirectML activation succeeded so telemetry can flag failures.
