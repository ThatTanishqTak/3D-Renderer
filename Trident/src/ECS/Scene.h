...
namespace Trident
{
     ...
     *
     * The scene acts as a façade around the central registry so tools can persist
    ...
    private:
        ECS::Registry* m_Registry{ nullptr };          ///< Registry backing the scene; owned externally by Application.
