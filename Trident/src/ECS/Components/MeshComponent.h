...
namespace Trident
{
    ...
    struct MeshComponent
    {
        ...
        /// Normalised asset path captured when the mesh was imported so the scene loader can rebuild geometry.
        std::string m_SourceAssetPath{};
        /// Index of the mesh inside the imported asset used to rebuild renderer indices on load.
        size_t m_SourceMeshIndex{ 0 };
    };
}